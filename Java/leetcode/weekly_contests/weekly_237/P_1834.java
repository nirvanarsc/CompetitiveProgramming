...
public class P_1834 {
    ...
    public int[] getOrder(int[][] tasks) {
        ...
        final int[][] indexed = new int[tasks.length][3];
        ...
        int idx = 0;
        final int[] res = new int[indexed.length];
        int resIdx = 0;
        while (idx < indexed.length || !pq.isEmpty()) {
            while (idx < indexed.length && indexed[idx][0] <= time) {
