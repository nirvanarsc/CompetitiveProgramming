...
public final class B {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final double angle = Math.toRadians(d - Math.toDegrees(Math.atan2(a, b)));
        final double r = Math.sqrt(a * a + b * b);
        final double ad = -r * Math.sin(angle);
        final double ab = r * Math.cos(angle);
        System.out.printf("%.6f %.6f", ad, ab);
    }
