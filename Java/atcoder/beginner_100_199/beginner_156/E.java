...
public final class E {
    ...
    public static void main(String[] args) {
        ...
        final Combinations comb = new Combinations((int) 4e5);
        long res = 0;
        for (int i = 0; i <= Math.min(n, k); i++) {
            // pick number of zeroes
            final long l = comb.nck(n, i);
            // combination with repetition for the remaining n-i terms
            final long r = comb.ncr(n - i, i);
