        ...
        while (stackIdx > 0) {
            ...
            if (idx[u] < g[u].length) {
                ...
                if (stackIdx > 0) {
                    ...
                    if (heavy[parent[u]] == -1 || size[heavy[parent[u]]] < size[u]) {
                        heavy[parent[u]] = u;
                    }
                }
            }
...
//    private static void dfs12(int u, int v) {
//        parent[u] = v;
//        depth[u] = depth[v] + 1;
//        in[u] = time++;
//        for (int next : g[u]) {
...
//    }
//
//    private static void dfs3(int u, int v) {
//        for (int next : g[u]) {
//            if (next != v) {
//                dfs2(next, u);
//            }
