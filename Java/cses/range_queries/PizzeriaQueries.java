...
public final class PizzeriaQueries {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final SegTree st1 = new SegTree(0, n - 1, arr1);
        final SegTree st2 = new SegTree(0, n - 1, arr2);
        ...
        for (int i = 0; i < q; i++) {
            ...
            if (t == 1) {
                final int v = fs.nextInt();
                st1.update(idx, v - idx);
                st2.update(idx, v + idx);
            } else {
                sb.append(Math.min(st1.query(0, idx) + idx, st2.query(idx, n - 1) - idx));
                sb.append('\n');
            }
        }
